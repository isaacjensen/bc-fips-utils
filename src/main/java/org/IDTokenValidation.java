...
public class IDTokenValidation {
    ...
    private static boolean verifyUsingPublicKey(byte[] data, byte[] signature, PublicKey pubKey, boolean fips) throws GeneralSecurityException
    {
        Signature sig;
        if(fips) {
    ...
    public static PublicKey getPublicKeyFromCert(String x5c, boolean fips) throws CertificateException, IOException, CertificateException, NoSuchProviderException {
